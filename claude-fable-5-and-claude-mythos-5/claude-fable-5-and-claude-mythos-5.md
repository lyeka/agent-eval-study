...
**Source:** [canonical URL](https://www.anthropic.com/news/claude-fable-5-mythos-5)

**Saved locally:** 2026-07-28

> Today we’re launching Claude Fable 5: a Mythos-class model that we’ve made safe for general use.

AnnouncementsJun 9, 2026![The number five composed of several butterflies](images/the-number-five-composed-of-several-butterflies.png)
...
Today we’re launching **Claude Fable 5**: a Mythos-class[1](#footnotes) model that we’ve made safe for general use.
...
For a small group of cyberdefenders and infrastructure providers, we’re also launching **Claude Mythos 5**. It’s the same underlying model as Fable 5, but with the safeguards lifted in some areas.[2](#footnotes) Mythos 5 will initially be deployed through [Project Glasswing](https://www.anthropic.com/glasswing), in collaboration with the US government, as an upgrade to Claude Mythos Preview. It has the strongest cybersecurity capabilities of any model in the world. Soon, we intend to expand access to Mythos 5 through a broader trusted access program.
...
![Benchmark table showing Claude Fable and Mythos compared to other leading models](images/benchmark-table-showing-claude-fable-and-mythos-compared-to-othe.png)
...
![Protein complexes designed by Mythos 5. Targets include immune checkpoints, growth-factor and receptor signaling, neurodegeneration, muscle disease, and harder structural targets.](images/protein-complexes-designed-by-mythos-5-targets-include-immune-ch.png)
...
![Overall level of misaligned behaviors from our automated alignment assessment. See section 6.2.3.1 of the system card for more.](images/overall-level-of-misaligned-behaviors-from-our-automated-alignme.png)
...
![Results of running cyber evaluations, 3 with Fable 5 in a mode that blocks responses rather than falling back to Opus 4.8. Evaluations did not involve attempts to evade safeguards.](images/results-of-running-cyber-evaluations-3-with-fable-5-in-a-mode-th.png)
...
![Results of an evaluation in which our models predicted the unpublished experimental properties of the viral shell of a simple virus. Viral shell assembly is the simplest viral trait to predict in this context, but it is nonetheless an important property to get right when designing more complex features. AAV = adeno-associated virus.](images/results-of-an-evaluation-in-which-our-models-predicted-the-unpub.png)
