...
![The prompt chaining workflow](images/the-prompt-chaining-workflow.png)
...
![The routing workflow](images/the-routing-workflow.png)
...
![The parallelization workflow](images/the-parallelization-workflow.png)
...
![The orchestrator-workers workflow](images/the-orchestrator-workers-workflow.png)
...
![The evaluator-optimizer workflow](images/the-evaluator-optimizer-workflow.png)
...
![High-level flow of a coding agent](images/high-level-flow-of-a-coding-agent.png)
